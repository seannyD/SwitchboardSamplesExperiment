...
main.plot2 <- ggplot(sumStats2,
  ...
  ylab("Proportion of 'Question' responses") +
  coord_cartesian(ylim=c(0,1)) + 
  scale_color_manual("First Phoneme",labels=(c("None","Other","wh")),
                     values = (hues),
                     breaks = c("none",'other','wh'))+
  scale_shape_manual("First Phoneme",labels=(c("None","Other","wh")),values = (c(17,18,19))) +
